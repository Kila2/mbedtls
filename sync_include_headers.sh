...
SOURCE_TF_PSA_CRYPTO_DRIVERS_BUILTIN_MBEDTLS_INCLUDE="tf-psa-crypto/drivers/builtin/include/mbedtls"
SOURCE_TF_PSA_CRYPTO_MBEDTLS_INCLUDE="tf-psa-crypto/include/mbedtls"
SOURCE_TF_PSA_CRYPTO_INCLUDE="tf-psa-crypto/include/tf-psa-crypto"
SOURCE_PSA_INCLUDE="tf-psa-crypto/include/psa"
...
cp -R "$SOURCE_TF_PSA_CRYPTO_DRIVERS_BUILTIN_MBEDTLS_INCLUDE" "$TARGET_INCLUDE_DIR/"
cp -R "$SOURCE_TF_PSA_CRYPTO_MBEDTLS_INCLUDE" "$TARGET_INCLUDE_DIR/"
cp -R "$SOURCE_TF_PSA_CRYPTO_INCLUDE" "$TARGET_INCLUDE_DIR/"
